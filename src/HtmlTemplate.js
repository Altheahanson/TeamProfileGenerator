...
// Creating the html layout and inserting card for each team member
...
// used to store/hold the html
const html = [];

// takes each team member from the team array. Filters their role and creates them with the cerate function
// Then pushes the html to the html array
html.push(team
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 jumbotron text-white mb-3">
                    <h1 class="text-center"> Rockstar Team </h1>
                </div>
            </div>
        </div>
        <div class="container">
